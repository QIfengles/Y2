...
public class UserServlet extends HttpServlet {
	...
	private void query(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {
		//查询用户列表
		Integer createdBy=(((User)request.getSession().getAttribute(Constants.USER_SESSION)).getId());
    	...
    	//总数量（表）	
    	int totalCount	= userService.getUserCount(queryUserName,queryUserRole,createdBy);
    	//总页数
		...
		userList = userService.getUserList(queryUserName,queryUserRole,pages.getCurrentPageNo(), pages.getPageSize(),createdBy);
